...
$currentElement = '';
$currentLoc = '';
$map = '<input type="text" id="myInput" onkeyup="mySearchFunction()" placeholder="Filter Product List..">
<table id="myTable">';
...
function endElement($parser, $name)
{
 ...
 if ( $currentElement == 'loc') {
    ...
    //echo $currentElement.' '.$currentLoc.'||';
    $currentLoc = '';
  };
 };
 $currentElement = '';
...
// print output
//echo $header
//echo '<script>window.onload = function() {document.getElementById(waiting).innerHTML="<h2>Index file created, please access at the link below</h2>";}</script>';
echo '<h2>Index file created, please access at the link below</h2>';
echo '<p><a href="'.$destfile.'">'.$destfile.' direct link</a></p>';
echo '</body></html>';